...
from src.utils.plotter import TensorboardPlotter
...
if __name__ == '__main__':
    ...
    # Get plotter
    plotter_path = os.path.join(opt['log_tb_dir'], opt['model_name'], opt['task'])
    opt['plotter'] = TensorboardPlotter(plotter_path)
